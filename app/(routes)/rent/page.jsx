...
import { Search, Grid, List, CircleDollarSign, Home } from "lucide-react";
import { supabase } from '@/Utils/supabase/client';
import FilterSection from '@/components/custom/FilterSection';
import PropertyCard, { PropertyCardLoading } from "@/components/custom/PropertyCard";
import {
  Select,
  SelectContent,
  SelectItem,
...
const Rent = () => {
  ...
  // Helper function to display selected values for rent prices
  const getPriceRangeDisplay = (value) => {
    if (!value) return null;

    switch (value) {
      case "0-20000":
        return "Under Ksh 20K";
      case "20000-50000":
        return "Ksh 20K - 50K";
      case "50000-100000":
        return "Ksh 50K - 100K";
      case "100000+":
        return "Over Ksh 100K";
      default:
        return null;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header - Changed gradient colors for rent */}
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mb-8 text-xl text-white/90">
              Discover your perfect rental home from our curated collection of properties
            </p>
              ...
              <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-4">
                <div className="md:col-span-2">
                  <input
                    ...
                    className="w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  />
                </div>
                <Select
                  value={priceRange}
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="0-20000">Under Ksh 20K</SelectItem>
                    <SelectItem value="20000-50000">Ksh 20K - 50K</SelectItem>
                    <SelectItem value="50000-100000">Ksh 50K - 100K</SelectItem>
                    <SelectItem value="100000+">Over Ksh 100K</SelectItem>
                  </SelectContent>
                </Select>
                <Button
                  size="lg"
